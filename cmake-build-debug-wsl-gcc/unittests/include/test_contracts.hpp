...
#define MAKE_READ_WASM_ABI(CN,C, D)                                                         \
   static std::vector<uint8_t> CN ## _wasm() {                                              \
      std::string s;                                                                        \
      fc::read_file_contents("/mnt/e/source/repos/leap-experiments/cmadhLeap2/cmake-build-debug-wsl-gcc/unittests/" #D "/" #C "/" #C ".wasm", s); \
      return std::vector<uint8_t>(s.begin(), s.end());                                      \
   }                                                                                        \
   static std::vector<char> CN ## _abi() {                                                  \
      std::string s;                                                                        \
      fc::read_file_contents("/mnt/e/source/repos/leap-experiments/cmadhLeap2/cmake-build-debug-wsl-gcc/unittests/" #D "/" #C "/" #C ".abi", s);  \
