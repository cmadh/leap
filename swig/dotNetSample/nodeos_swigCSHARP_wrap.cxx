...
SWIGEXPORT int SWIGSTDCALL CSharp_NodeosSwig_Start(void * jarg1, int jarg2, void * jarg3, void * jarg4) {
  ...
  int arg2 ;
  char **arg3 = (char **) 0 ;
  swig_logger_base arg4 ;
  swig_logger_base *argp4 ;
  int result;
  
  arg1 = (NodeosSwig *)jarg1; 
  arg2 = (int)jarg2; 
  arg3 = (char **)jarg3; 
  argp4 = (swig_logger_base *)jarg4; 
  if (!argp4) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "Attempt to dereference null swig_logger_base", 0);
    return 0;
  }
  arg4 = *argp4; 
