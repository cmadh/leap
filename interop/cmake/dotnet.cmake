...
if(USE_DOTNET_CORE_31 AND USE_DOTNET_7)
  set(DOTNET_TFM "<TargetFrameworks>netcoreapp3.1;net7.0</TargetFrameworks>")
elseif(USE_DOTNET_7)
  set(DOTNET_TFM "<TargetFramework>net7.0</TargetFramework>")
...
configure_file(${PROJECT_SOURCE_DIR}/nodeos/dotnet/Directory.Build.props.in ${PROJECT_BINARY_DIR}/nodeos/dotnet/Directory.Build.props)
...
configure_file(
  ${PROJECT_SOURCE_DIR}/nodeos/dotnet/${DOTNET_PACKAGE}.runtime.csproj.in
...
####################
configure_file(
  ${PROJECT_SOURCE_DIR}/nodeos/dotnet/${DOTNET_PROJECT}.csproj.in
...
add_custom_target(nodeos_interop_dotnet ALL
  DEPENDS
