...
<<<<<<< HEAD
      validating_tester(const flat_set<account_name>& trusted_producers = flat_set<account_name>(), deep_mind_handler_base* dmlog = nullptr) {
=======
...
>>>>>>> main
      ...
      static unique_ptr<controller> create_validating_node(controller::config vcfg, const genesis_state& genesis, bool use_genesis, deep_mind_handler_base* dmlog = nullptr) {
